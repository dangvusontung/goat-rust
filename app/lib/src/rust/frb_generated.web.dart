...
@protected ActiveBeatDto dco_decode_active_beat_dto(dynamic raw);

@protected AttrDto dco_decode_attr_dto(dynamic raw);

@protected AwardDto dco_decode_award_dto(dynamic raw);

@protected BeatChoiceDto dco_decode_beat_choice_dto(dynamic raw);

@protected BeatOutcomeDto dco_decode_beat_outcome_dto(dynamic raw);

@protected bool dco_decode_bool(dynamic raw);

@protected ActiveBeatDto dco_decode_box_autoadd_active_beat_dto(dynamic raw);

@protected BeatOutcomeDto dco_decode_box_autoadd_beat_outcome_dto(dynamic raw);

@protected GoatGameState dco_decode_box_autoadd_goat_game_state(dynamic raw);
...
@protected LegacyDto dco_decode_legacy_dto(dynamic raw);

@protected List<String> dco_decode_list_String(dynamic raw);

@protected List<AttrDto> dco_decode_list_attr_dto(dynamic raw);

@protected List<AwardDto> dco_decode_list_award_dto(dynamic raw);
...
@protected List<TransferOfferDto> dco_decode_list_transfer_offer_dto(dynamic raw);

@protected List<WeekFixtureDto> dco_decode_list_week_fixture_dto(dynamic raw);

@protected MatchResultDto dco_decode_match_result_dto(dynamic raw);

@protected ActiveBeatDto? dco_decode_opt_box_autoadd_active_beat_dto(dynamic raw);

@protected BeatOutcomeDto? dco_decode_opt_box_autoadd_beat_outcome_dto(dynamic raw);
...
@protected TransferOfferDto dco_decode_transfer_offer_dto(dynamic raw);
...
@protected ActiveBeatDto sse_decode_active_beat_dto(SseDeserializer deserializer);

@protected AttrDto sse_decode_attr_dto(SseDeserializer deserializer);

@protected AwardDto sse_decode_award_dto(SseDeserializer deserializer);

@protected BeatChoiceDto sse_decode_beat_choice_dto(SseDeserializer deserializer);

@protected BeatOutcomeDto sse_decode_beat_outcome_dto(SseDeserializer deserializer);

@protected bool sse_decode_bool(SseDeserializer deserializer);

@protected ActiveBeatDto sse_decode_box_autoadd_active_beat_dto(SseDeserializer deserializer);

@protected BeatOutcomeDto sse_decode_box_autoadd_beat_outcome_dto(SseDeserializer deserializer);

@protected GoatGameState sse_decode_box_autoadd_goat_game_state(SseDeserializer deserializer);
...
@protected LegacyDto sse_decode_legacy_dto(SseDeserializer deserializer);

@protected List<String> sse_decode_list_String(SseDeserializer deserializer);

@protected List<AttrDto> sse_decode_list_attr_dto(SseDeserializer deserializer);

@protected List<AwardDto> sse_decode_list_award_dto(SseDeserializer deserializer);
...
@protected List<TransferOfferDto> sse_decode_list_transfer_offer_dto(SseDeserializer deserializer);

@protected List<WeekFixtureDto> sse_decode_list_week_fixture_dto(SseDeserializer deserializer);

@protected MatchResultDto sse_decode_match_result_dto(SseDeserializer deserializer);

@protected ActiveBeatDto? sse_decode_opt_box_autoadd_active_beat_dto(SseDeserializer deserializer);

@protected BeatOutcomeDto? sse_decode_opt_box_autoadd_beat_outcome_dto(SseDeserializer deserializer);
...
@protected TransferOfferDto sse_decode_transfer_offer_dto(SseDeserializer deserializer);
...
@protected void sse_encode_active_beat_dto(ActiveBeatDto self, SseSerializer serializer);

@protected void sse_encode_attr_dto(AttrDto self, SseSerializer serializer);

@protected void sse_encode_award_dto(AwardDto self, SseSerializer serializer);

@protected void sse_encode_beat_choice_dto(BeatChoiceDto self, SseSerializer serializer);

@protected void sse_encode_beat_outcome_dto(BeatOutcomeDto self, SseSerializer serializer);

@protected void sse_encode_bool(bool self, SseSerializer serializer);

@protected void sse_encode_box_autoadd_active_beat_dto(ActiveBeatDto self, SseSerializer serializer);

@protected void sse_encode_box_autoadd_beat_outcome_dto(BeatOutcomeDto self, SseSerializer serializer);

@protected void sse_encode_box_autoadd_goat_game_state(GoatGameState self, SseSerializer serializer);
...
@protected void sse_encode_legacy_dto(LegacyDto self, SseSerializer serializer);

@protected void sse_encode_list_String(List<String> self, SseSerializer serializer);

@protected void sse_encode_list_attr_dto(List<AttrDto> self, SseSerializer serializer);

@protected void sse_encode_list_award_dto(List<AwardDto> self, SseSerializer serializer);
...
@protected void sse_encode_list_transfer_offer_dto(List<TransferOfferDto> self, SseSerializer serializer);

@protected void sse_encode_list_week_fixture_dto(List<WeekFixtureDto> self, SseSerializer serializer);

@protected void sse_encode_match_result_dto(MatchResultDto self, SseSerializer serializer);

@protected void sse_encode_opt_box_autoadd_active_beat_dto(ActiveBeatDto? self, SseSerializer serializer);

@protected void sse_encode_opt_box_autoadd_beat_outcome_dto(BeatOutcomeDto? self, SseSerializer serializer);
...
@protected void sse_encode_transfer_offer_dto(TransferOfferDto self, SseSerializer serializer);
